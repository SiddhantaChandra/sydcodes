...
import ExperienceTitle from '../components/ExperienceComponents/ExperienceTitle';
import ExperienceTab from '../components/ExperienceComponents/ExperienceTab';
import ExperienceCard from '../components/ExperienceComponents/ExperienceCard';
import EducationCard from '../components/ExperienceComponents/EducationCard';
  ...
  const experienceItems = [
    {
      ...
      companyImg: '/images/company-images/onlybees_logo.webp',
      ...
      techstack: [
        { name: 'Next.js', icon: '/images/icons-tech/nextjs.svg' },
        { name: 'React.js', icon: '/images/icons-tech/react.svg' },
        { name: 'JavaScript', icon: '/images/icons-tech/javascript.svg' },
        { name: 'Tailwind CSS', icon: '/images/icons-tech/tailwind.svg' },
      ],
    },
    {
      role: 'CricketWinner LLC',
      company: 'Frontend Developer',
      companyImg: '/images/company-images/cricketwinner.webp',
      ...
      techstack: [
        { name: 'React', icon: '/images/icons-tech/react.svg' },
        { name: 'SASS', icon: '/images/icons-tech/scss.svg' },
        { name: 'JavaScript', icon: '/images/icons-tech/javascript.svg' },
        { name: 'Figma', icon: '/images/icons-tech/figma.svg' },
      ],
    },
  ];
